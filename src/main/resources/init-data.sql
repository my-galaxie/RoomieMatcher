-- This script should be run manually only once to initialize sample data
-- It will not run automatically with the application
...
BEGIN
    IF NOT EXISTS (SELECT 1 FROM users LIMIT 1) THEN
        ...
        PERFORM setval('users_id_seq', 1100, true);
        
        RAISE NOTICE 'Sample data inserted successfully';
    ELSE
        RAISE NOTICE 'Data already exists, skipping sample data insertion';
    END IF;
END
$$; 